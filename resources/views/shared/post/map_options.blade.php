<div style="padding:10px;margin-top:10px;border:1px solid #eee;-webkit-border-radius: 4px;-moz-border-radius: 4px;border-radius: 4px;">
    ...
    @endif
        ...
        <div class="row">
            <div class="col-12 text-center">
                <a class="btn btn-dark" style="margin-top:10px;padding:5px;background:#666;-webkit-border-radius: 4px !important;-moz-border-radius: 4px !important;border-radius: 4px !important;" target="_blank" href="https://www.google.com/maps/search/?api=1&query={{$post->lat}},{{$post->lng}}">
