<div class="clearfix">
    <span class="pull-left" style="font-size:16px;">
        ...
        <a  href="#" data-post_id="{{ $post->id }}" id="likeBtn" class="btn post-toolbar-btn  ">
            <i style="width: 36px;height: 36px; -webkit-border-radius: 99999em;-moz-border-radius: 99999em;border-radius: 99999em; padding-top: 19px;padding-left: 6px;background: #666; "  class="fa fa-heart {{ $alreadyLiked ? 'text-success' : 'text-white' }}"></i><br>
        ...
        <a  data-toggle="kt-tooltip" title="" data-placement="right" data-original-title="I Was Here!" href="#" data-post_id="{{ $post->id }}" id="visitedBtn"  class="btn post-toolbar-btn  ">
            <i style="width: 36px;height: 36px; -webkit-border-radius: 99999em;-moz-border-radius: 99999em;border-radius: 99999em; padding-top: 19px;padding-left: 6px;background: #666;" class="fa fa-shoe-prints {{ $alreadyVisited ? 'text-success' : 'text-white' }}"></i><br>
