<div class="flex justify-end">
    <a  href="#" data-post_id="{{ $post->id }}" id="likeBtn" class="btn post-toolbar-btn  flex flex-col items-center mr-10 ">
        <i style="width: 36px;height: 36px; -webkit-border-radius: 99999em;-moz-border-radius: 99999em;border-radius: 99999em; padding-top: 19px;padding-left: 6px;background: #474747; "  class="fa fa-heart {{ $alreadyLiked ? 'text-success' : 'text-white' }}"></i>
