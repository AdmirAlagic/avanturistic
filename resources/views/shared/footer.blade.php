        ...
        <div class="kt-container ">
                ...
                <div class="col-sm-3">
                    <div class="kt-footer__section">
                        <h4 class="kt-footer__title text-center text-gray">
                            Follow <span class="text-gray">@</span>avanturistic
                        </h4>
                        <div class="kt-footer__content text-center" style="color:#f8f8fb;text-align: justify;">
                           
                          
                            <a class="text-white text-light" target="_blank" href="https://www.facebook.com/avanturistic">
                                <img class="lazy" src="/img/placeholder-dark.svg"  data-src="/img/social/fb-white.svg"  data-srcset="/img/social/fb-white.svg" alt="Avanturistic Facebook profile" style="width: 28px; height: 28px;margin-right: 2px;">
                            </a>
                            &nbsp;
                            <a  class="text-white text-light" target="_blank" href="https://www.instagram.com/avanturistic.com.app">
                                <img class="lazy" src="/img/placeholder-dark.svg"  data-src="/img/social/instagram-white.svg" data-srcset="/img/social/instagram-white.svg" alt="Avanturistic Instagram profile"  style="width: 30px; height: 30px;margin-left:1px;margin-right: 2px;">
                            </a>
            ...
            <div class="col-sm-3">
                <div class="kt-footer__section">
                    ...
                    <div class="kt-footer__content text-center" style="color:#f8f8fb;text-align: justify;">
                    <p>
                        <a class="text-white" href="/countries">
                            Countries
                        </a>
                    </p>
                    <p>
                    ...
                    <p>
                     ...
                     <p>
                        <a class="text-muted" href="mailto:info@avanturistic.com"><b>info@avanturistic.com</b></a>
                     </p>
                    </div>
                </div>
                    ...
                    <div class="col-sm-3">
                        ...
                        <div class="kt-footer__section">
                            ...
                            <div class="kt-footer__content text-center" style="color:#f8f8fb;text-align: justify;">
                               ...
                               <br> 
                                    <img class="lazy br-8" alt="Avanturistic app on Google Play" src="/img/placeholder-dark.svg"  data-src="{{ url('/img/qrcode.svg') }}" data-srcset="{{ url('/img/qrcode.svg') }}"  style="width: 120px; height: 120px;">
                                    <br><br>
                               </div>
