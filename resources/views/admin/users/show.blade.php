                ...
                <div class="kt-portlet kt-portlet--tabs">
                    <div class="kt-portlet__head">
                        <div class="kt-portlet__head-toolbar">
                            <ul class="nav nav-tabs nav-tabs-space-xl nav-tabs-line nav-tabs-bold nav-tabs-line-3x nav-tabs-line-brand"
                                role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link" data-toggle="tab" href="#kt_user_info" role="tab">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" data-toggle="tab" href="#kt_user_profile" role="tab">
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                             xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px"
                                             viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" data-toggle="tab" href="#kt_user_password" role="tab">
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                             xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px"
                                             viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <div class="kt-portlet__body">
                        <div class="tab-content">
                            <div class="tab-pane active" id="kt_user_info">
                                        ...
                                        <div class="kt-section kt-section--first">
                                            <div class="kt-section__body">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-9 col-xl-6">
                                                        <input class="form-control" type="text"
                                                               value="{{$user->first_name}}" readonly="1">
                                                    </div>
                                                </div>
                                                @if(isset($user->middle_name))
                                                    <div class="form-group row">
                                                        <label class="col-xl-3 col-lg-3 col-form-label">Middle
                                                            Name</label>
                                                        <div class="col-lg-9 col-xl-6">
                                                            <input class="form-control" type="text"
                                                                   value="{{$user->middle_name}}" readonly="1">
                                                        </div>
                                                    </div>
                                                @endif
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-9 col-xl-6">
                                                        <input class="form-control" type="text"
                                                               value="{{$user->last_name}}" readonly="1">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-9 col-xl-6">
                                                        <input class="form-control" type="text"
                                                               value="{{$user->country_id}}" readonly="1">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-xl-3 col-lg-3 col-form-label">Signed up</label>
                                                    <div class="col-lg-9 col-xl-6">
                                                        <input class="form-control" type="text"
                            ...
                            <div class="tab-pane" id="kt_user_profile">
                                <form class="kt-form kt-form--label-right">
                                    <div class="kt-portlet__body">
                                        <div class="kt-section kt-section--first">
                                            <div class="kt-section__body">
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-xl-3 col-lg-3 col-form-label">User ranks</label>
                                                    <div class="col-lg-9 col-xl-6">
                                                        @foreach($userRanks as $rank)
                                                            <div class="input-group" style="padding-bottom: 1rem">
                                                                <input class="form-control" type="text"
                                                                       value="{{$rank->name}}" readonly="1">
                                                            </div>
                                                        @endforeach
                                                    </div>
                                                </div>
                            ...
                            <div class="tab-pane" id="kt_user_password" role="tabpanel">
