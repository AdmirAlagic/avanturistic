        ...
        <div class="kt" style=" padding: 50px 10px 50px 10px;background:rgba(0,0,0,0.6);color:white;">
            ...
            <div class="kt-portlet_body">
                <div class="kt-container text-center">
                    ...
                    <h3 class="text-center"><br> Explore <b>latest</b> outdoor trips or find outdoor activities <em><b>near you</b></em>.</h3>
           ...
           <div class="kt-container" style="padding:0px;">
               ...
               <!-- <div class="row">
                   <div class="col-sm-12 text-center" style="padding:0px;"> -->
                       ...
                       <div class="kt-container" style="min-height:600px;background:#FFFFFF;" id="posts-container" data-page="{{ request()->filled('page') ? request()->page : 1 }}" >
