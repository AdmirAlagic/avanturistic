...
$(document).ready(function(){
    ...
    $(document).on('click', '#nav-link-visited-countries', function (e) {
        resizeWindow();
    });
    function initMap(){
        var lat,lng,center,zoom;
        lat = $('#country-lat').val();
        lng = $('#country-lng').val();
        center= {lat:30,lng:0};
        zoom = 2;
        var map = L.map('visiteds-map', {
            zoom: zoom,
            center: center,
        ...
        function whenClicked(e) {
            ...
            var country_id = layer.feature.id;
            if($.inArray(country_id, visited_countries) > -1){
                ...
                if(index >= 0) visited_countries.splice(index, 1);
            } else {
...
$(function(){
    if(location.hash.includes('#')){
        ...
        if(location.hash === '#visited-countries')
           {
            resizeWindow();
           }
           console.log(location.hash.replace('#',''));
        $('#nav-link-'+location.hash.replace('#','')).addClass('active');
    }
})