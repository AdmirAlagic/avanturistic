...
$(document).ready(function(){
    ...
    var addedMarkers =  L.layerGroup();
    var user_id = $('#hidden-user_id').val();
    var visited_countries = [];
    function setMarkers(posts, map){
        ...
        $.each(posts, function(index, val){
            ...
            if(val.image !== null){
                ...
                iconUrl =  val.image[0].thumb_path;
            } else {
                iconUrl = '/img/marker_frame.png';
            }
            var mIcon = L.icon({
            ...
            markerOptions =  {icon: mIcon, url : baseUrl + '/adventure/' + val.id};
    ...
    $.ajax({
        url: '/getVisitedCountries?user_id='+user_id,
        method:'GET',
